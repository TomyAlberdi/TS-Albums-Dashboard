...
const AlbumCard = ({ album }: AlbumCardProps) => {
  ...
  return (
    <Card className="cursor-pointer p-2 gap-0 min-w-[150px] w-[48%] md:w-[13.4%] min-h-[175px] h-[27vh] md:h-[30vh] mb-[4%] md:mb-[1.03%] rounded-md bg-black/30 md:hover:-translate-y-3 md:hover:scale-100 transition-transform duration-300 ease-in-out shadow-lg z-20 flex flex-col justify-start items-center">
      <div
